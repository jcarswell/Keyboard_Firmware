...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_MOD1] = LAYOUT( /* CONTROL */
			...
			_______,         TO(_QWERTY), _______,     _______,     _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, RGB_MOD,         _______, _______, RESET,
			_______,         _______,     TO(_DVORAK), _______,     _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, RGB_RMOD,         _______,          EEP_RST,
