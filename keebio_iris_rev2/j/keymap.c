...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V,    KC_B,    LOWER,  RAISE,  KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_SCLN),
  ...
  [_COLMAK] = LAYOUT(
    ...
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V,    KC_B,    LOWER,  RAISE,  KC_K,   KC_M,   KC_COMM, KC_DOT, KC_QUOT, RSFT_T(KC_SLSH),
                               KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_DEL, KC_LALT
  ),
};
